...
function beforeFind (col, findPermissionFilteringListeners, query, req) {
...
module.exports = (col, findPermissionFilteringListeners) => {
  ...
  col.beforeFindListeners.add('auth-perm', col, (query, req) => beforeFind(col, findPermissionFilteringListeners, query, req))
}
